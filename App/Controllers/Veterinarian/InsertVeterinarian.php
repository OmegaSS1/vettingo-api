...
class InsertVeterinarian extends VeterinarianAction {
...
["Biografia","CRMV","Estado do CRMV","Telefone Profissional","Email Profissional","Atendo Emergências","Atendo em Domicílio"]);
        ...
        if($this->iVeterinarianRepository->findByUserId($this->USER->sub)){
            throw new Exception("Usuário já possui um perfil veterinário cadastrado", 404);
        }
