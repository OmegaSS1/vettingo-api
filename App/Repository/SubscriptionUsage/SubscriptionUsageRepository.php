...
namespace App\Repository\SubscriptionUsage;

use App\Traits\Helper;
use App\Model\Database;
use App\Model\SubscriptionUsage;

class SubscriptionUsageRepository implements ISubscriptionUsageRepository {
	use Helper;
	...
	private string $table = "subscription_usage";
	...
	private function getObject(array $data){
		foreach ($data as $v){
			$this->registers[$v[$this->columns[0]]] = new SubscriptionUsage(
...
interface ISubscriptionUsageRepository {
	 ...
	 * @param int $id
	 * @return array|SubscriptionUsage
	 */
	public function findBySubscriptionId(int $id);
