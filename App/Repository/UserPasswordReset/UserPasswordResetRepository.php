...
namespace App\Repository\UserPasswordReset;

use App\Traits\Helper;
use App\Model\Database;
use App\Model\UserPasswordReset;

class UserPasswordResetRepository implements IUserPasswordResetRepository {
	use Helper;
	...
	private string $table = "user_password_reset";
	...
	private function getObject(array $data){
		foreach ($data as $v){
			$this->registers[$v[$this->columns[0]]] = new UserPasswordReset(
...
interface IUserPasswordResetRepository {
	/**
	 * Summary of findByUserId
	 * @param int $id
	 * @return array|UserPasswordReset
	 */
	public function findByUserId(int $user_id);
