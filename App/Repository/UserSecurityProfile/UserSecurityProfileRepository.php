...
namespace App\Repository\UserSecurityProfile;

use App\Traits\Helper;
use App\Model\Database;
use App\Model\UserSecurityProfile;

class UserSecurityProfileRepository implements IUserSecurityProfileRepository {
	use Helper;
	...
	private string $table = "user_security_profile";
	...
	private function getObject(array $data){
		foreach ($data as $v){
			$this->registers[$v[$this->columns[0]]] = new UserSecurityProfile(
...
interface IUserSecurityProfileRepository {
	/**
	 * Summary of findByUserId
	 * @param int $user_id
	 * @return array|UserSecurityProfile
	 */
	public function findByUserId(int $user_id);
