...
namespace App\Repository\VetSpecialization;

use App\Traits\Helper;
use App\Model\Database;
use App\Model\VetSpecialization;

class VetSpecializationRepository implements IVetSpecializationRepository {
	use Helper;

    /**
     * @var VetSpecialization[]
     */
    private array $registers = [];
	private Database $database;
	private string $table = "vet_specialization";
	...
	private function getObject(array $data){
		foreach ($data as $v){
			$this->registers[$v[$this->columns[0]]] = new VetSpecialization(
...
interface IVetSpecializationRepository {
	/**
	 * Summary of findByVeterinarianId
	 * @param int $id
	 * @return array|VetSpecialization
	 */
	public function findByVeterinarianId(int $id);
